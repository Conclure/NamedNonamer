...
public abstract class SpecializedCommand<S extends CommandSender> extends Command {
    ...
    protected abstract void executeSuccessfully(S sender, CommandArguments arguments);
    ...
    @Override
    public final void execute(CommandSender sender, CommandArguments arguments) {
